...
import com.warchaser.musicplayer.tools.MessageHandler;
...
import com.warchaser.musicplayer.tools.StatusBarUtil;
...
public class MediaControllerService extends Service {
    ...
    private static class MessageCallback extends MessageHandler<MediaControllerService> {
        ...
        public void handleMessage(MediaControllerService mediaControllerService, Message msg) {
